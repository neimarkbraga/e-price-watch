        ...
        <div class="panel-body">
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane fade" id="aboutuspanel">
                    ...
                    <div style="clear: both;"></div>
                    <p id="aboutus_content" style="white-space: pre-line; width: 95%; margin: auto;"> <?php $sql = 'SELECT * FROM about_us WHERE ID=1'; $result = mysql_query($sql, $con); if($row = mysql_fetch_array($result)) {echo $row['DESCRIPTION']; } ?> </p>
