...
if(isset($_GET['STORE']) && isset($_GET['ADDRESS']))
{
    ...
    $sql = 'SELECT * FROM encoded_products WHERE STORENAME = "' . mysql_escape_string($page_store_name) . '" AND ADDRESS = "' . mysql_escape_string($page_store_address) . '"';
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-footer">
            ...
            <div class="row my_thumb_container">
                <?php
                    $argument = 'AND encoded_products.STORENAME = "' . mysql_escape_string($page_store_name) . '" AND encoded_products.ADDRESS = "' . mysql_escape_string($page_store_address) .'"';
